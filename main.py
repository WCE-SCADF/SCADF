...
def main(args):
    ...
    if mode == 'train':
        ...
        from models.model import EC_MSSCADF
        model = EC_MSSCADF(upscale_factor=args.scale)
...
if __name__ == '__main__':
    ...
    # Mode specifications
    parser.add_argument('--mode', default='train', choices=('train', 'test'), help='Mode For (train | test)')
    ...
    # Data specifications
    parser.add_argument("--train_hr_dir", default='training_high directory path', type=str,
                        help="Train Dataset GT Image Directory")
    parser.add_argument("--train_lr_dir", default='training_low directory path', type=str,
                        help="Train Dataset LR Image Directory")
    parser.add_argument("--valid_hr_dir", default='validation_high directory path', type=str,
                        help="Valid Dataset GT Image Directory")
    parser.add_argument("--valid_lr_dir", default='validation_low directory path', type=str,
                        help="Valid Dataset LR Image Directory")
    parser.add_argument("--test_hr_dir", default='testing_high directory path', type=str,
                        help="Test Dataset GT Image Directory")
    parser.add_argument("--test_lr_dir", default='testing_low directory path', type=str,
    ...
    parser.add_argument('--model', default='EC-MSSCADF', help='Model Name')
    parser.add_argument('--scale', type=int, default=1, help='Super Resolution Scale')
    parser.add_argument('--data_range', type=int, default=255, choices=(1, 255),
    ...
    parser.add_argument("--epochs", default=200, type=int, help="Numbers of Epochs To Train")
    parser.add_argument('--loss_function', default='Charbonnier', choices=('L1', 'L2', 'Charbonnier', 'Custom'),
                        help='Loss Fuction (L1 Loss | L2 loss | Charbonnier Loss)')
    parser.add_argument("--val_per_epoch", default=1, type=int, help="Valid PSNR/SSIM Every n Epochs")
    ...
    parser.add_argument("--psnr_ssim_y", default=False,
